  ...
  pl: {
    translation: {
      ...
      detail: {
        ...
        vehicleLocation: "Lokalizacja pojazdu",
        gallery: "Galeria",
        photos: "zdjęć",
        vin: "VIN",
      ...
      consent: {
        banner: {
          ...
          body: "Używamy plików cookies do działania serwisu oraz — za Twoją zgodą — do analityki i marketingu. Możesz zaakceptować wszystkie, odrzucić opcjonalne albo dostosować wybór. Decyzję zmienisz w dowolnym momencie w stopce.",
        ...
        dialog: {
          ...
          description: "Wybierz, na jakie kategorie cookies wyrażasz zgodę. Niezbędne są zawsze aktywne, ponieważ bez nich serwis nie działa poprawnie.",
          save: "Zapisz wybór",
          acceptAll: "Akceptuję wszystkie",
        ...
        categories: {
          necessary: {
            ...
            description: "Wymagane do działania strony — zapamiętanie Twojej zgody, bezpieczeństwo sesji, podstawowe preferencje. Nie można ich wyłączyć.",
          },
          analytics: {
            title: "Analityczne",
            description: "Pomagają nam zrozumieć jak korzystasz ze strony (Google Analytics 4). Dane są zagregowane i anonimowe.",
          },
          marketing: {
            title: "Marketingowe",
            description: "Umożliwiają mierzenie skuteczności kampanii reklamowych i wyświetlanie spersonalizowanych reklam (Google Ads).",
          },
        },
      },
    },
    ...
    translation: {
      ...
      consent: {
        banner: {
          ...
          body: "We use cookies to run the site and — with your consent — for analytics and marketing. You can accept all, reject optional ones, or customize your choice. Change your decision anytime via the footer.",
        ...
        dialog: {
          ...
          description: "Choose which categories of cookies you allow. Necessary cookies are always on because the site cannot function without them.",
          save: "Save choices",
          acceptAll: "Accept all",
          rejectOptional: "Reject optional",
          close: "Close",
        ...
        categories: {
          necessary: {
            title: "Necessary",
            always: "Always on",
            description: "Required for the site to work — remembering your consent, session security, basic preferences. They cannot be disabled.",
          },
          analytics: {
            title: "Analytics",
            description: "Help us understand how you use the site (Google Analytics 4). Data is aggregated and anonymous.",
          },
          marketing: {
            title: "Marketing",
            description: "Measure the effectiveness of ad campaigns and enable personalised ads (Google Ads).",
          },
        },
      },
    },
    ...
    translation: {
      ...
      consent: {
        banner: {
          ...
          body: "Wir verwenden Cookies für den Betrieb der Seite und — mit Ihrer Einwilligung — für Analyse und Marketing. Sie können alle akzeptieren, optionale ablehnen oder Ihre Auswahl anpassen. Sie können Ihre Entscheidung jederzeit über die Fußzeile ändern.",
        ...
        dialog: {
          ...
          description: "Wählen Sie, welchen Kategorien von Cookies Sie zustimmen. Notwendige Cookies sind immer aktiv, da die Seite ohne sie nicht funktioniert.",
        ...
        categories: {
          necessary: {
            title: "Notwendig",
            always: "Immer aktiv",
            description: "Erforderlich für den Betrieb — Speicherung Ihrer Einwilligung, Sitzungssicherheit, grundlegende Einstellungen. Kann nicht deaktiviert werden.",
          },
          analytics: {
            title: "Analyse",
            description: "Helfen uns zu verstehen, wie Sie die Seite nutzen (Google Analytics 4). Daten sind aggregiert und anonym.",
          },
          marketing: {
            title: "Marketing",
            description: "Messen Sie die Wirksamkeit von Werbekampagnen und ermöglichen Sie personalisierte Anzeigen (Google Ads).",
          },
        },
      },
    },
